FLASH_CARDS = {
    ...
    "dm": {  # dba120 midterm
        ...
        "column": 'In a relational database, fields are commonly represented as ____s and may be referred to as "____s."',
        ...
        "concatenate": "The combining the contents of two or more columns or character strings. Two vertical bars, or pipes (||), instruct Oracle 12c to ____ the output of a query.",
        ...
        "database object": "A defined, self-contained structure in Oracle 12c. ____ ____s include tables, sequences, indexes, and synonyms.",
        ...
        "row": "A group of column values for a specific occurrence of an entity. In a database, records are commonly represented as ____s.",
        ...
        "substitution variable": "Instructs Oracle 12c to use a substituted value in place of a specific variable at the time a command is executed. Used to make SQL statements or PL/SQL blocks interactive.",
        ...
        "transaction": "A series of DML statements is considered to be one ____. In Oracle 12c, a ____ is simply a series of statements that have been issued and not committed. The duration of a ____ is defined by when a COMMIT implicitly or explicitly occurs.",
        "transaction control": "Data control statements that either save modified data or undo uncommitted changes made in error",
